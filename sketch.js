...
{
  ff =createElement('h1')  
  ff.html("This app will help you to make very important decisions in");
  ff.position(20,100);
  
  fw =createElement('h1')
  fw.html(" life with absolute randomness.");
  fw.position(20,125);

  c = createElement('h1')
  c.html(" You can  also use it as tie breaker ");
  c.position(20,170);
...
h =createElement('h2');
h.html("How many possibilities would you like ???");
 h.position(10,270) ;
...

{
  h.hide();
t =createElement('h2');
t.html("Write The Options And Then Click On Next")
t.position(10,280)
